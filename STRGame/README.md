...
✅ __2.__ ~~Теперь вы можете запустить __main.c__, чтобы узнать за какое время выполняются ваши функции.~~ (soon) 
...
✅ __2.__ Добавлено __20 __ новых тестов для функции split()
