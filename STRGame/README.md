...
✅ __main.c__ __КОМПИЛИРОВАТЬ__ __ТОЛЬКО__ __С__ __КЛЮЧОМ__ __-Wl,--stack,10000000000__ (для увеличения размера стека)
...
__4.__ Миша Нитенко - STRTOK - 0, SPLIT - 1 🔥

__5.__ Паша Топорков - STRTOK 1, SPLIT - 1 🔥

__6.__ Дима Якуба - STRTOK - 1 (0), SPLIT - 1 🔥
...
__main.c__ __КОМПИЛИРОВАТЬ__ __ТОЛЬКО__ __С__ __КЛЮЧОМ__ __-Wl,--stack,10000000000__ 
...
2. Компилируем и запускаем main.c (Компилировать ТОЛЬКО с ключом __-Wl,--stack,10000000000__ )
